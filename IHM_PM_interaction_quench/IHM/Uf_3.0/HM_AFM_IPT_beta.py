...
U_f=3.0           # final value of the interaction after quench
...
cmd_ex = "./noneq-dmft_IHM2 %s %f %f %f %f %i %i %i %i %f %s %i %f %f"%(dos, beta, t_max, U_i, U_f, N_tau, N_t, N_e, N_iter, tolerance, solver,init, mix, delta)
print cmd_ex
...
copy("densityA", "densityA_U%s"%U_f)
copy("densityB", "densityB_U%s"%U_f)
copy("double-occupancyA", "double-occupancyA_U%s"%U_f)
copy("double-occupancyB", "double-occupancyB_U%s"%U_f)
copy("kinetic-energyA", "kinetic-energyA_U%s"%U_f)
copy("kinetic-energyB", "kinetic-energyB_U%s"%U_f)
copy("interaction-energyA", "interaction-energyA_U%s"%U_f)
copy("interaction-energyB", "interaction-energyB_U%s"%U_f)
copy("total-energyA", "total-energyA_U%s"%U_f)
copy("total-energyB", "total-energyB_U%s"%U_f)
