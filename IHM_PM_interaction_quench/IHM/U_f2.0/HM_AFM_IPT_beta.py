...
copy("densityA", "densityA_%s"%U_f)
copy("densityB", "densityB_%s"%U_f)
copy("double-occupancyA", "double-occupancyA_%s"%U_f)
copy("double-occupancyB", "double-occupancyB_%s"%U_f)
copy("kinetic-energyA", "kinetic-energyA_%s"%U_f)
copy("kinetic-energyB", "kinetic-energyB_%s"%U_f)
copy("interaction-energyA", "interaction-energyA_%s"%U_f)
copy("interaction-energyB", "interaction-energyB_%s"%U_f)
copy("total-energyA", "total-energyA_%s"%U_f)
copy("total-energyB", "total-energyB_%s"%U_f)
