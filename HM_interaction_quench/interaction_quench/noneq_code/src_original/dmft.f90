...
module DMFT_MOD
  ...
  type, public :: dmft
     ...
     type(KB_derivative)          :: local_green_der_e     ! derivative of Weiss Green function d/dt G(t,t') will be used to calculate dn(t)
     type(KB_derivative)          :: local_green_der_e_new     ! derivative of Weiss Green function d/dt G(t,t') will be used to calculate dn(t)
